...
<div class="theme-elden-ring">
  ...
  <div class="guide-layout">
    ...
    <main class="guide-content">
      ...
      <div class="guide-card-item" style="display: flex; flex-wrap: wrap; align-items: center; justify-content: space-between; gap: 1.5rem; background: linear-gradient(90deg, rgba(212, 175, 55, 0.1) 0%, transparent 100%); border-left: 4px solid var(--gold); padding: 2rem; margin: 3rem 0; border-radius: 4px;">
    ...
    Read Guide →
      ...
      <section class="guide-section" id="combat">
        ...
        <div class="guide-tabs">
          ...
          <div class="guide-tab-panel active" id="c-basics">
            <div class="guide-cards">
              <div class="guide-card-item"><span class="guide-card-icon">🛡️</span><h3>Guard Counters</h3><p>Press heavy attack immediately after blocking to stagger enemies and open critical windows.</p></div>
              <div class="guide-card-item"><span class="guide-card-icon">⚡</span><h3>Dodge & I-Frames</h3><p>Rolling gives you invincibility frames. Always roll INTO large attacks, not away from them.</p></div>
            </div>
          </div>
      ...
      <section class="guide-section" id="world">
        ...
        <div class="region-grid">
          <div class="region-card"><span class="region-emoji">🌿</span><div class="region-name">Limgrave</div><div class="region-desc">The starting region of plains and forests.</div></div>
          <div class="region-card"><span class="region-emoji">🏰</span><div class="region-name">Leyndell</div><div class="region-desc">The political heart and golden capital.</div></div>
          <div class="region-card"><span class="region-emoji">🏜️</span><div class="region-name" style="color: #8C2D2D;">Caelid</div><div class="region-desc">Mid-game zone corrupted by the deadly Scarlet Rot.</div></div>
        </div>

        <h3 style="font-family:var(--font-display);font-size:1.5rem;color:var(--text);margin:2.5rem 0 1.25rem;">Secret Merchants</h3>
      ...
      <h3 style="font-family:var(--font-display);font-size:1.5rem;color:var(--text);margin:3rem 0 1.25rem;">Major Factions & Demigods</h3>
      <div class="guide-cards">
        <div class="guide-card-item" style="border-top: 3px solid #f1c40f;">
      ...
      <section class="guide-section" id="puzzles">
        ...
        <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; margin-bottom: 2rem;">
          <a href="extras/evergaols" style="display: inline-flex; align-items: center; gap: 0.6rem; background: rgba(138, 43, 226, 0.15); border: 1px solid #A29BFE; color: #A29BFE; padding: 0.8rem 1.5rem; border-radius: 6px; font-weight: bold; text-decoration: none; font-size: 1.05rem; transition: all 0.3s ease;"
          ...
          <a href="extras/divine-towers" style="display: inline-flex; align-items: center; gap: 0.6rem; background: rgba(212, 175, 55, 0.15); border: 1px solid #D4AF37; color: #D4AF37; padding: 0.8rem 1.5rem; border-radius: 6px; font-weight: bold; text-decoration: none; font-size: 1.05rem; transition: all 0.3s ease;"
      ...
      <section class="guide-section" id="treasures">
        <span class="label">Chapter 5</span>
        <h2 class="guide-section-title">Legendary Armaments</h2>
        <div class="guide-cards">
          <div class="guide-card-item"><span class="guide-card-icon">🗡️</span><h3>Dark Moon Greatsword</h3><p>Mythic weapon located beneath the Cathedral of Manus Celes. Earned via Ranni's Questline.</p></div>
          <div class="guide-card-item"><span class="guide-card-icon">🌟</span><h3>Sword of Night and Flame</h3><p>Legendary armament. Found in a locked chest in Caria Manor. Scales with INT and FAI.</p></div>
          <div class="guide-card-item"><span class="guide-card-icon">🏴‍☠️</span><h3 style="color:var(--gold); transition:color 0.2s; text-transform:uppercase;">Marais Executioner's Sword</h3><p>Dropped by Elemer of the Briar in The Shaded Castle. Deals massive drill damage.</p></div>
          <div class="guide-card-item"><span class="guide-card-icon">👑</span><h3 style="color:var(--gold); transition:color 0.2s; text-transform:uppercase;">Bolt of Gransax</h3><p>Ancient artifact found upon the giant golden spear in Leyndell. Missable if not collected before the endgame!</p></div>
          <div class="guide-card-item"><span class="guide-card-icon">❄️</span><h3 style="color:var(--gold); transition:color 0.2s; text-transform:uppercase;">Ruins Greatsword</h3><p>Legendary weapon found in Redmane Castle Plaza after defeating the Misbegotten Warrior duo.</p></div>
          <div class="guide-card-item"><span class="guide-card-icon">🏮</span><h3 style="color:var(--gold); transition:color 0.2s; text-transform:uppercase;">Golden Order Greatsword</h3><p>A sword made of pure light, dropped by the Misbegotten Crusader in the Cave of the Forlorn.</p></div>
        </div>
        <div style="text-align: center; margin-top: 2rem;">
      ...
      <section class="guide-section" id="activities">
      ...
      <section class="guide-section" id="walkthrough">
        <span class="label">Chapter 7</span>
        <h2 class="guide-section-title">Main Quest Walkthrough</h2>
        <p class="guide-section-intro">Select a chapter below for a meticulous, step-by-step guide including hidden items and complete boss strategies.</p>

        <div class="guide-cards">
          <a href="chapters/prologue" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🌙</span>
          ...
          <a href="chapters/chapter-1" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">⚔️</span>
          ...
          <a href="chapters/chapter-2" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🏰</span>
          ...
          <a href="chapters/chapter-3" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🏔️</span>
          ...
          <a href="chapters/chapter-4" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🏜️</span>
          ...
          <a href="chapters/chapter-5" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">👑</span>
          ...
          <a href="chapters/chapter-6" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">❄️</span>
          ...
          <a href="chapters/chapter-7" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🌪️</span>
          ...
          <a href="chapters/chapter-8" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🔥</span>
          ...
          <a href="chapters/dlc" class="guide-card-item" style="text-decoration:none; border-color: #9b59b6;">
            <span class="guide-card-icon">🌑</span>
      ...
      <section class="guide-section" id="extras">
        ...
        <p class="guide-section-intro">Deep dives into specific game mechanics, NPC storylines, and endgame content.</p>

        <div class="guide-cards">
          <a href="extras/achievements" class="guide-card-item" style="text-decoration:none; border-color: rgba(46, 204, 113, 0.4);">
            <span class="guide-card-icon">🏆</span>
          ...
          <a href="extras/quests" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">🤝</span>
          ...
          <a href="extras/fashion" class="guide-card-item" style="text-decoration:none;">
            <span class="guide-card-icon">👗</span>
          ...
          <a href="faq" class="guide-card-item" style="text-decoration:none; border-color: rgba(212, 175, 55, 0.6); background: rgba(212, 175, 55, 0.05);">
            <span class="guide-card-icon">❓</span>
...
window.guideSiteIndex = [
    ...
    { title: "DLC: Shadow of the Erdtree", url: "chapters/dlc", tags: "walkthrough, ending, finale, true ending, chapter", category: "Walkthrough" },
