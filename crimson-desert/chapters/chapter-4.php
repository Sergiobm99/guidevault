...
?>
  ...
  <header class="guide-hero" style="min-height: 40vh; padding-top: calc(var(--nav-h) + 2rem);">
    <div class="guide-hero-bg" style="background: linear-gradient(to bottom, rgba(8,8,8,0.4) 0%, rgba(8,8,8,1) 100%), url('/crimson-desert/img/chapter4.jpg') center/cover no-repeat;"></div>
    ...
    <div class="guide-hero-inner">
      ...
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem); color: var(--gold); line-height: 1.1; margin-bottom: 1rem;">Chapter 4: The Endless Sand</h1>
  ...
  <div class="guide-layout responsive-layout">
    ...
    <aside class="guide-toc desktop-toc" aria-label="Table of contents">
        ...
        <ul class="guide-toc-list" style="border-left: 1px solid rgba(255,255,255,0.1); padding-left: 1rem;">
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#crossing" style="color: var(--text-dim); transition: color 0.2s;">1. Crossing the Sea of Dust</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#nomad" style="color: var(--text-dim); transition: color 0.2s;">2. The Nomad Encampment</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#temple" style="color: var(--text-dim); transition: color 0.2s;">3. The Sunken Temple</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#boss-burrower" style="color: var(--text-dim); transition: color 0.2s;">4. Boss: Sand-Burrower</a></li>
    ...
    <main class="guide-content">
      ...
      <section class="guide-section reveal" id="crossing" style="margin-bottom: 4rem;">
        <div class="callout danger" style="margin-bottom: 3rem; background: rgba(140, 45, 45, 0.08); border-left: 4px solid #8C2D2D; padding: 1.5rem;">
          <span class="callout-label" style="color: #ff4d4d; font-weight: bold; text-transform: uppercase;">⚠ Survival Mechanic: Heatstroke & Quicksand</span>
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">Walking in the Akapen Desert during the day causes the <strong>Heatstroke</strong> debuff. Your maximum stamina will decrease every minute. Travel at night or consume "Chilled Cactus Juice". Additionally, watch out for patches of darker, shifting sand—these are <strong>quicksand pits</strong> that will instantly drown Kliff.</p>
        </div>

        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">1. Crossing the Sea of Dust</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">Your journey begins at the Southern Pass. The goal is to reach the Nomad Capital, but the path is obscured by constant sandstorms.</p>
        ...
        <ul class="step-list">
          <li class="step reveal">
            ...
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">The Camel Merchant</h4>
              <p style="color: #ccc;">Standard horses will struggle in the deep sand. Locate the merchant <strong>Zaid</strong> at the entrance of the desert. He will trade a Camel for 2,000 Gold. Camels don't lose stamina in sand and have an innate resistance to heat.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Navigate by the Stars</h4>
              <p style="color: #ccc;">During a sandstorm, your minimap will glitch. Look up at the sky; the <strong>Abyss Constellation</strong> (three bright purple stars) always points exactly North toward the Sunken Temple.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">3</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">The Night Traders</h4>
              <p style="color: #ccc;">While crossing, you may spot a blue campfire. These belong to the Silent Nomads, who only trade at night. Stop here to buy <em>"Nomad's Silk"</em>, a crafting material you will need later to upgrade your heat-resistant armor.</p>
        ...
        <div class="callout danger reveal" style="margin-top:2rem; border-left: 4px solid var(--gold); background: rgba(212, 168, 67, 0.08); padding: 1.5rem;">
          <span class="callout-label" style="color: var(--gold); font-weight: bold; text-transform: uppercase;">Enemy Ambush: Dune Scorpions</span>
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">If your controller starts vibrating softly while riding, a Dune Scorpion is tracking you underground. <strong>Do not dismount.</strong> Sprint in a zig-zag pattern until the vibration stops. If you fight them, use heavy blunt weapons to crack their carapace.</p>
        </div>
        ...
        <div class="reveal" style="background: rgba(212, 168, 67, 0.05); border: 1px dashed var(--gold); padding: 1.5rem; border-radius: 4px; margin-top: 2rem;">
            <h4 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-bottom: 0.5rem; margin-top: 0;">💰 Pro-Tip: The Dune Scorpion Gold Farm</h4>
      ...
      <section class="guide-section reveal" id="nomad" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">2. The Nomad Encampment & Side Quests</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">Before reaching the temple, you will discover the hidden Oasis Encampment. This acts as your primary hub for Chapter 4.</p>

        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Upgrade your Waterskin</h4>
              <p style="color: #ccc;">Speak to the camp Elder. He will upgrade your standard flask into a <strong>Nomad's Waterskin</strong>, which holds 5 charges instead of 3 and prevents water from evaporating in the heat.</p>
            </div>
          </li>
        </ul>
        ...
        <div class="guide-accordion open reveal" id="acc-c4-sq" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1.5rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">Do not skip this quest! Talk to the crying merchant near the tents. He asks you to find his lost caravan to the East.</p>
      ...
      <section class="guide-section reveal" id="temple" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">3. The Sunken Temple & The Oasis Rift</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">To advance the story, you must enter the Sunken Temple of Akapen. This area features the most complex light-based puzzles in the game.</p>
        ...
        <div class="guide-accordion open reveal" id="acc-c4-1" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1.5rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">In the main hall, you must redirect sunlight to hit the central pedestal. However, some mirrors are "Mirages" (illusions).</p>
              <ul style="list-style: square; padding-left: 1.5rem; color: #ccc;">
        ...
        <div class="guide-accordion open reveal" id="acc-c4-2" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1.5rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">Before proceeding down the temple stairs, exit through the broken eastern wall. You will find a small pool of water.</p>
              <ul style="list-style: square; padding-left: 1.5rem; color: #ccc;">
      ...
      <section class="guide-section reveal" id="boss-burrower" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">4. Chapter Boss: Colossal Sand-Burrower</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">This massive centipede-like creature attacks from beneath the sand. It is a battle of patience and timing.</p>
          ...
          <table class="guide-table" style="width: 100%; border-collapse: collapse; background: var(--dark-2);">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Phase 1 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Submerged)</span></td>
              ...
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Phase 2 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Exposed)</span></td>
              ...
              <tr>
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Final Phase <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Enraged)</span></td>
        ...
        <div class="callout abyss reveal" style="margin-top:2rem; background: rgba(138, 43, 226, 0.08); border-left: 4px solid #A29BFE; padding: 1.5rem;">
          ...
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">Defeating the Sand-Burrower grants the <strong>"Fragment of the Sands"</strong>. This unlocks the <strong>Sand-Dash</strong> ability, allowing Kliff to move rapidly across any surface (including water) for a short duration.</p>
        </div>
      </section>

      <section class="guide-section reveal" id="hidden" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">5. Chapter 4 Hidden Treasures & Materials</h2>
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid var(--gold);">
            ...
            <h3 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Nomad’s Curved Dagger</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Hidden in the "Small Oasis" to the West. You must dive into the water and find a small underwater tunnel leading to a secret air pocket.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #3498db;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">🛡️</span>
            <h3 style="color: #3498db; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Sun-Kissed Shield</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Located in the Sunken Temple. In the mirror room, redirect the light to the <em>small</em> statue on the left instead of the main door.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #e74c3c;">
            ...
            <h3 style="color: #e74c3c; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Ancient Akapen Urn</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Found at the top of the "Leaning Tower" ruins. Requires a high level of stamina or the Sand-Dash ability to reach the summit.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #2ecc71;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">🌺</span>
            <h3 style="color: #2ecc71; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Farming: Desert Rose</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">A rare alchemy ingredient. It only spawns on the eastern dunes right after a Sandstorm ends. Essential for crafting Max Health potions.</p>
          </div>
        </div>
      </section>

      <section class="guide-section reveal" id="completion" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">6. Chapter 4 Completion</h2>
        ...
        <div class="reveal" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 1.5rem; margin-bottom: 3rem;">
            <ul class="guide-checklist">
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Ability Unlocked:</strong> Did you defeat the Sand-Burrower and acquire the Sand-Dash?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Reputation Maintained:</strong> Did you return the goods in "The Lost Caravan" quest?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Hidden Rift:</strong> Have you cleared the Oasis Abyss Rift at midnight?</span>
                    </label>
                </li>
            </ul>
        </div>
        ...
        <div class="chapter-nav">
            <a href="/crimson-desert/chapters/chapter-3.php" style="color: var(--text-dim); text-decoration: none; font-family: var(--font-ui); text-transform: uppercase; letter-spacing: 1px; font-size: 0.9rem;">← Previous: Chapter 3</a>
            <a href="/crimson-desert/chapters/chapter-5.php" class="btn btn-gold">Next: Chapter 5 →</a>
        </div>
