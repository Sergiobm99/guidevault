...
?>
  ...
  <header class="guide-hero" style="min-height: 45vh; padding-top: calc(var(--nav-h) + 2rem);">
    ...
    <div class="guide-hero-inner">
      ...
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem);">The True Mercenary</h1>
  ...
  <div class="guide-layout" style="grid-template-columns: 1fr; max-width: 950px; margin: 0 auto;">
    <main class="guide-content">
      ...
      <section class="guide-section reveal">
        <div class="callout abyss" style="margin-bottom: 3rem; background: rgba(138, 43, 226, 0.08); border-left: 4px solid #A29BFE;">
          <span class="callout-label" style="color: #A29BFE;">🌀 What is the End-Game?</span>
          <p>After the credits roll, Pywel changes. The Abyss Master Key allows you to unlock challenges that were previously invisible. This is where you test your skills against Level 100+ enemies, tackle the infinite dungeon, and craft the final tier of equipment.</p>
        </div>

        <h2 class="guide-section-title">1. Abyssal Nightmare (NG+)</h2>
        <p>In New Game+, you can select the <strong>Abyssal Nightmare</strong> difficulty. This isn't just a health boost for enemies; it changes their AI behavior completely.</p>

        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">Advanced Enemy AI</h4>
              <p>Enemies will now parry your attacks, use elemental combos against you, and call for reinforcements much faster. Your "Transcendence" mode is no longer an "I win" button; use it only to break boss shields.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">The Level 100 Cap</h4>
              <p>While the story ends around Level 50, the post-game allows you to reach Level 100. Each level past 60 requires <strong>Abyss Echoes</strong> (dropped by world bosses) instead of standard XP.</p>
            </div>
          </li>
        </ul>
<div class="reveal" style="background: rgba(46, 204, 113, 0.1); border-left: 3px solid #2ecc71; padding: 1.5rem; margin-top: 2rem; border-radius: 0 4px 4px 0;">
            <h4 style="color: #2ecc71; font-family: var(--font-display); font-size: 1.3rem; margin-bottom: 0.5rem;">👑 The NG+ Meta Build: "The Immortal Void-Walker"</h4>
        ...
        <h2 class="guide-section-title reveal">2. The Shifting Labyrinth (Endless Mode)</h2>
        <p class="reveal">Located beneath the ruins of Pailune, this is a rogue-lite infinite dungeon. Every floor is procedurally generated with random enemies, traps, and bosses.</p>
        ...
        <div class="reveal" style="background: rgba(212, 168, 67, 0.05); border: 1px dashed var(--gold); padding: 1.5rem; border-radius: 4px; margin-top: 2rem;">
            <h4 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-bottom: 0.5rem;">💰 Pro-Tip: Astral Coin Farming</h4>
        ...
        <h2 class="guide-section-title reveal">3. Ultimate Superboss: The Nameless Sovereign</h2>
        <p class="reveal">This is the true final challenge of Crimson Desert. A boss so powerful it requires a perfectly min-maxed build and absolute mastery of the Axiom Force.</p>

        <div class="callout danger reveal" style="border-left: 4px solid var(--red); background: rgba(140, 45, 45, 0.08); margin-top: 1.5rem; margin-bottom: 2rem;">
          <span class="callout-label" style="color: var(--red);">⚠ How to Unlock the Sovereign</span>
          <p style="color: #ccc;">You must collect the <strong>7 Shattered Crowns</strong> hidden exclusively in NG+ across the map (they replace standard chests in high-level Abyss Rifts). Take them to the throne in the Sunken Temple of Akapen to summon him.</p>
        </div>
        ...
        <div class="guide-table-wrap reveal" style="margin-top: 1rem; overflow-x: auto;">
          <table class="guide-table" style="width: 100%; border-collapse: collapse; background: var(--dark-2);">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold;">Phase 1 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(100%-60%)</span></td>
              ...
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold;">Phase 2 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(60%-20%)</span></td>
              ...
              <tr>
                <td style="padding: 1rem; font-weight: bold;">Final Phase <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(20%-0%)</span></td>
        ...
        <h2 class="guide-section-title reveal">4. The Crimson Arena (PvP & Co-op)</h2>
        <p class="reveal">Head to the Gladiator's Pit in Hernand to access the multiplayer features of the game.</p>
        ...
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #e74c3c;">
            ...
            <h3 style="color: #e74c3c; font-family: var(--font-display); font-size: 1.3rem;">1v1 Duels</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Test your build against other players. Stats are normalized, meaning victory relies entirely on your mastery of parrying, stamina management, and combo execution.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #3498db;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">🛡️</span>
            <h3 style="color: #3498db; font-family: var(--font-display); font-size: 1.3rem;">Mercenary Co-op Raids</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Team up with up to 3 friends to tackle "World Tier" bosses. These bosses have millions of HP and require coordinated team attacks and dedicated support/tank roles.</p>
          </div>
        </div>

        <hr style="border-color: rgba(255,255,255,0.05); margin: 3rem 0;">

        <h2 class="guide-section-title reveal">5. The 100% Checklist & Void Crafting</h2>
        
        <div class="callout info reveal" style="margin-bottom: 2rem; border-left: 4px solid var(--gold); background: rgba(212, 168, 67, 0.08);">
          <span class="callout-label" style="color: var(--gold);">Crafting the "God-Slayer" Set</span>
          <p style="color: #ccc;">To craft the final armor and upgrade weapons to +20, you need <strong>Pure Void Crystals</strong>. These only drop from Ascended Bosses in NG+ with a 5% drop rate. Equip the <em>Royal Signet Ring</em> to boost your luck.</p>
        </div>
        ...
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid var(--gold);">
            ...
            <h3 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem;">All 40 Abyss Rifts</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Complete every rift on Master difficulty to unlock the secret "Eternal Mercenary" title and a golden skin for Kliff.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #9b59b6;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">📜</span>
            <h3 style="color: #9b59b6; font-family: var(--font-display); font-size: 1.3rem;">Lore Scholar</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Find all 120 journals. The final journal is only available in NG+ inside the King's secret library.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #2ecc71;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">🐎</span>
            <h3 style="color: #2ecc71; font-family: var(--font-display); font-size: 1.3rem;">The Nightmare Steed</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Win the "Grand Pailune Race" in NG+ to unlock the fastest mount in the game: a horse infused with Abyss energy.</p>
          </div>
        </div>
<hr style="border-color: rgba(255,255,255,0.05); margin: 4rem 0;">
        <h2 class="guide-section-title reveal">6. The 100% Completionist Checklist</h2>
        ...
        <div class="reveal" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 1.5rem; margin-bottom: 3rem;">
            <ul class="guide-checklist">
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>The Endless Depths:</strong> Reach Floor 100 in the Shifting Labyrinth.</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>God Slayer:</strong> Defeat the Nameless Sovereign on Abyssal Nightmare difficulty.</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>Max Arsenal:</strong> Upgrade at least one Mythic weapon to +20 using Pure Void Crystals.</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>The Completionist:</strong> Collect all 120 Lore Journals and clear all 40 Abyss Rifts.</span>
                    </label>
                </li>
            </ul>
        </div>
        <div class="reveal" style="margin-top: 5rem; text-align: center;">
          <a href="../" class="btn btn-gold" style="padding: 1rem 3rem; font-size: 1.1rem;">← Back to Crimson Desert Hub</a>
        </div>
