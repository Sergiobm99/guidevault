...
?>
  ...
  <header class="guide-hero" style="min-height: 45vh; padding-top: calc(var(--nav-h) + 2rem);">
    <div class="guide-hero-bg" style="background: linear-gradient(to bottom, rgba(8,8,8,0.4) 0%, rgba(8,8,8,1) 100%), url('/crimson-desert/img/chapter8.webp') center/cover no-repeat;"></div>
