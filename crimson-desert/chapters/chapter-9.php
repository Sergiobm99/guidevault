...
?>
  ...
  <header class="guide-hero" style="min-height: 45vh; padding-top: calc(var(--nav-h) + 2rem);">
    ...
    <div class="guide-hero-inner">
      ...
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem);">Chapter 9: The Last Greymane</h1>
    ...
    <main class="guide-content">
      ...
      <section class="guide-section reveal">
        ...
        <div class="callout danger" style="margin-bottom: 3rem; background: rgba(140, 45, 45, 0.08); border-left: 4px solid #8C2D2D;">
          <span class="callout-label" style="color: #ff4d4d;">⚠ Absolute Point of No Return</span>
          <p>Once you step into the <strong>Origin Portal</strong> at the start of this chapter, you cannot return to the open world of Pywel until the credits roll. Make sure you are fully prepared.</p>
        </div>

        <h2 class="guide-section-title">1. The Ultimate Preparation Checklist</h2>
        <p>Do not enter the Abyss without the following loadout, or you will struggle immensely during the final boss rush:</p>
        
        <ul style="margin-top: 1rem; color: #ccc; line-height: 1.6; padding-left: 1.5rem;" class="reveal">
        ...
        <div class="reveal" style="background: rgba(212, 168, 67, 0.05); border: 1px dashed var(--gold); padding: 1.5rem; border-radius: 4px; margin-top: 2rem;">
            <h4 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-bottom: 0.5rem;">🎒 Pro-Tip: The "God-Slayer" Loadout</h4>
        ...
        <h2 class="guide-section-title reveal">2. The Descent into Origin</h2>
        <p class="reveal">The true mastermind is revealed. Myurdin, leader of the Black Bears, has reached the heart of the Abyss to absorb its primeval energy. You must fight your way through the echoes of your past to stop him.</p>

        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">The Gauntlet of Shadows</h4>
              <p>As you descend the cosmic staircase, you will face shadow-clones of previous bosses (including the Rat King and Vulkan). They have less health but hit significantly harder. Use your <strong>Transcendence</strong> mode (unlocked in Ch. 8) to clear these waves quickly without wasting your healing potions.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">The Greymane Reunion</h4>
              <p>Before the final gate, the spirits of your companions (Oongka, Yann, and Naira) will appear to hold off the Abyss Army. Speak to each one to receive the <strong>"Eternal Bond"</strong> permanent buff, which boosts your stamina regeneration and attack speed by 20% for the final fight.</p>
            </div>
          </li>
        </ul>
        ...
        <h2 class="guide-section-title reveal">3. Final Boss: Myurdin, The Abyss Vessel</h2>
        <p class="reveal">Myurdin wields a colossal greatsword and possesses every Axiom Force ability Kliff has. This is the ultimate mirror match of skill, parrying, and timing.</p>
          ...
          <table class="guide-table" style="width: 100%; border-collapse: collapse; background: var(--dark-2);">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold;">Phase 1 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Melee Duel)</span></td>
              ...
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold;">Phase 2 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Abyss Weaver)</span></td>
              ...
              <tr>
                <td style="padding: 1rem; font-weight: bold;">Final Phase <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Zero Gravity)</span></td>
        ...
        <div class="guide-accordion reveal" id="acc-c9-secretboss" style="background: rgba(212, 168, 67, 0.05); border: 1px solid var(--gold); border-radius: 4px; margin-top: 2rem;">
          <button class="guide-accordion-trigger" onclick="toggleAcc('acc-c9-secretboss')" style="width: 100%; padding: 1rem 1.5rem; display: flex; justify-content: space-between; align-items: center; cursor: pointer; color: var(--gold); border-bottom: 1px solid rgba(212, 168, 67, 0.2);">
            <span class="guide-accordion-label" style="font-family: var(--font-display); font-size: 1.2rem; letter-spacing: 1px;">⚠ Secret Phase: The Origin Core Manifestation (True Ending Only)</span>
        ...
        <h2 class="guide-section-title reveal">4. Multiple Endings Guide</h2>
        <p class="reveal">After the battle, you will stand before the fading Origin Core. Your dialogue choice here determines the fate of the continent.</p>
        ...
        <div class="reveal" style="margin-top: 1.5rem; margin-bottom: 2rem;">
            <img src="/crimson-desert/img/finale.jpg" style="width: 100%; height: 350px; object-fit: cover; border-radius: 8px; border: 1px solid rgba(212, 168, 67, 0.3);" alt="The Fate of Pywel">
            <p style="text-align: center; font-size: 0.8rem; color: var(--text-muted); margin-top: 0.5rem; font-style: italic;">The destiny of the continent rests solely on your shoulders.</p>
        </div>
        ...
        <div class="guide-accordion reveal" id="acc-c9-2" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1rem;">
        ...
        <div class="guide-accordion reveal" id="acc-c9-3" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1rem;">
        ...
        <h2 class="guide-section-title reveal">5. Post-Game: What's Next? (New Game+)</h2>
        <p class="reveal">After any of the endings, you will be prompted to save your clear data. Loading this data grants access to <strong>New Game+</strong>.</p>
        
        <ul style="margin-top: 1rem; margin-bottom: 3rem; color: #ccc; line-height: 1.6; padding-left: 1.5rem;" class="reveal">
          ...
          <li><strong>NG+ Exclusives:</strong> Enemies are scaled to Level 50+. A new difficulty mode, "Abyssal Nightmare," is unlocked. You can now farm <em>Pure Void Crystals</em> to upgrade gear beyond the normal limits.</li>
        </ul>

        <h2 class="guide-section-title reveal">6. Chapter 9 Hidden Treasures</h2>
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #e74c3c;">
            ...
            <h3 style="color: #e74c3c; font-family: var(--font-display); font-size: 1.3rem;">Blade of the Origin</h3>
            <p style="font-size: 0.9rem; color: #ccc;">During the Gauntlet of Shadows, look for a golden rift on your right. Enter it to find the final Mythic weapon. It deals 2x damage against Abyss enemies.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #3498db;">
            ...
            <h3 style="color: #3498db; font-family: var(--font-display); font-size: 1.3rem;">Developer's Secret Stash</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Behind the throne of the shadow clone of the Rat King. Roll into the invisible wall to find a room filled with early concept art models and 10,000 Gold.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid var(--gold);">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">💍</span>
            <h3 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem;">Band of Brotherhood</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Automatically awarded if you speak to all 3 companions before the final door. Grants +50% XP and Gold in New Game+.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #9b59b6;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">📜</span>
            <h3 style="color: #9b59b6; font-family: var(--font-display); font-size: 1.3rem;">The Last Journal</h3>
            <p style="font-size: 0.9rem; color: #ccc;">Hidden behind the Origin Core. You must collect it <em>before</em> interacting with the Core to trigger the ending sequence. Completes the 100% Lore Log Achievement.</p>
          </div>
        </div>

        <hr style="border-color: rgba(255,255,255,0.05); margin: 4rem 0;">

        <h2 class="guide-section-title reveal">7. The Absolute Completionist (100% Secrets)</h2>
        <div class="callout info reveal" style="border-left: 4px solid var(--gold); background: rgba(212, 168, 67, 0.08); margin-bottom: 2rem;">
          <span class="callout-label" style="color: var(--gold);">The Secret Post-Credits Scene</span>
          <p style="color: #ccc;">If you achieve <strong>Ending C (True Ending)</strong>, do NOT skip the credits. Wait exactly 3 minutes after the screen goes black. You will hear a brief audio log of the Primeval Voice whispering: <em>"The Core is broken, but the Roots remain..."</em> This unlocks a secret cosmetic cape in your inventory for NG+.</p>
        </div>
        <ul style="margin-top: 1rem; color: #ccc; line-height: 1.6; padding-left: 1.5rem;" class="reveal">
          <li style="margin-bottom: 0.5rem;"><strong>No-Hit Challenge Reward:</strong> If you defeat Myurdin (both phases) without taking a single point of damage, you automatically unlock the <em>"Flawless Vessel"</em> alternate outfit for Kliff.</li>
          <li><strong>Speedrunner Easter Egg:</strong> If your total playtime for Chapter 9 from entering the portal to reaching the core is under 12 minutes, a small glowing fox (the developer's mascot) will be sitting on top of the Origin Core.</li>
        </ul>

        <hr style="border-color: rgba(255,255,255,0.05); margin: 4rem 0;">
        <h2 class="guide-section-title reveal">8. Journey's End</h2>
        ...
        <div class="reveal" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 1.5rem; margin-bottom: 3rem;">
            <ul class="guide-checklist">
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>True Ending:</strong> Did you defeat the Origin Core Manifestation?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>Secret Scene:</strong> Did you watch the post-credits cutscene completely?</span>
                    </label>
                </li>
            </ul>
        </div>
        ...
        <div class="reveal" style="border-left: 4px solid #3498db; padding: 1.5rem; background: var(--dark-2); border-radius: 0 4px 4px 0; display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <h4 style="color: #3498db; font-family: var(--font-display); font-size: 1.4rem; margin-bottom: 0.2rem; letter-spacing: 1px;">Platinum Trophy Unlocked</h4>
        ...
        <div class="reveal" style="margin-top: 5rem; text-align: center;">
          ...
          <p style="color: var(--text-muted); margin-bottom: 2rem;">You have conquered the Crimson Desert to its absolute core.</p>
            ...
            <h4 style="color: var(--gold); font-family: var(--font-display); font-size: 1.5rem; margin-bottom: 1rem;">🗡️ A Word from the Author</h4>
          ...
          <a href="post-game.php" class="btn btn-gold" style="padding: 1rem 3rem; font-size: 1.1rem;">Explore Post-Game Guide</a>
        </div>
