...
?>
  ...
  <header class="guide-hero" style="min-height: 45vh; padding-top: calc(var(--nav-h) + 2rem);">
    <div class="guide-hero-bg" style="background: linear-gradient(to bottom, rgba(8,8,8,0.4) 0%, rgba(8,8,8,1) 100%), url('/crimson-desert/img/chapter7.webp') center/cover no-repeat;"></div>
    ...
    <div class="guide-hero-inner">
      ...
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem); color: var(--gold); line-height: 1.1; margin-bottom: 1rem;">Chapter 7: The Heart of the Abyss</h1>
  ...
  <div class="guide-layout responsive-layout">
    ...
    <aside class="guide-toc desktop-toc" aria-label="Table of contents">
        ...
        <ul class="guide-toc-list" style="border-left: 1px solid rgba(255,255,255,0.1); padding-left: 1rem;">
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#citadel" style="color: var(--text-dim); transition: color 0.2s;">1. The Floating Citadel</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#puzzles" style="color: var(--text-dim); transition: color 0.2s;">2. Gravitational Mirrors</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#boss-overlord" style="color: var(--text-dim); transition: color 0.2s;">3. Boss: Abyss Overlord</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#choice" style="color: var(--text-dim); transition: color 0.2s;">4. The Diverging Path</a></li>
    ...
    <main class="guide-content">
      ...
      <section class="guide-section reveal" id="citadel" style="margin-bottom: 4rem;">
        <div class="callout danger" style="margin-bottom: 3rem; background: rgba(140, 45, 45, 0.08); border-left: 4px solid #8C2D2D; padding: 1.5rem;">
          <span class="callout-label" style="color: #ff4d4d; font-weight: bold; text-transform: uppercase;">⚠ Point of No Return</span>
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">Before entering the portal to the Abyss, make sure you have completed all Companion Quests (Yann, Oongka, Naira) and spent your gold on upgrades. Once inside the Heart of the Abyss, you cannot fast-travel back to Pywel until you defeat the chapter boss.</p>
        </div>

        <div class="callout abyss reveal" style="margin-top: 1rem; margin-bottom: 3rem; background: rgba(138, 43, 226, 0.08); border-left: 4px solid #A29BFE; padding: 1.5rem;">
          <span class="callout-label" style="color: #A29BFE; font-weight: bold; text-transform: uppercase;">🌀 Abyss Mechanics: Zero Gravity</span>
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">In the Heart of the Abyss, gravity is inconsistent. You will find <strong>Gravity Wells</strong> (purple spheres) that allow Kliff to walk on walls and ceilings. Use the <em>Axiom Force</em> to toggle these wells on and off to navigate the floating debris.</p>
        </div>

        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">1. Reaching the Floating Citadel</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">After acquiring the elemental fragments from the previous chapters, the gateway at the center of the Crimson Desert finally opens. You are no longer in Pywel; you are in the realm of the Ancients.</p>
        ...
        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            ...
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Unlocking the Abyss Wings</h4>
              <p style="color: #ccc;">Immediately upon entry, a scripted event will merge your elemental fragments. This unlocks the <strong>Abyss Wings</strong>. By holding the jump button in mid-air, Kliff can now glide across massive gaps. This is the only way to reach the Citadel entrance.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">The Echoes of the Past</h4>
              <p style="color: #ccc;">Interact with the three "Echo Pillars" surrounding the entrance. You must use the <strong>[Observation]</strong> skill to watch the ghostly projections. They reveal the sequence needed to stabilize the bridge: <strong>Fire → Water → Earth</strong>.</p>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section class="guide-section reveal" id="puzzles" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">2. Gravitational Mirror Puzzles & Mini-Boss</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">The interior of the Citadel is a labyrinth of shifting rooms. You must redirect the "Abyss Light" using mirrors while simultaneously shifting the room's gravity.</p>
        ...
        <div class="guide-accordion open reveal" id="acc-c7-1" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1.5rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">This is the most complex puzzle in the game. You are in a giant spherical room with a central light source.</p>
        ...
        <div class="guide-accordion open reveal" id="acc-c7-miniboss" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">In the Grand Ocular room, before leaving, point the light beam directly at the shattered mirror in the corner. This summons Kliff's dark reflection.</p>
              <ul style="list-style: square; padding-left: 1.5rem; color: #ccc;">
      ...
      <section class="guide-section reveal" id="boss-overlord" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">3. Chapter Boss: The Abyss Overlord</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">The Overlord is the guardian of the Abyss Core. He does not use physical weapons; he manipulates the very fabric of the realm against you.</p>
        ...
        <div class="reveal" style="background: rgba(212, 168, 67, 0.05); border: 1px dashed var(--gold); padding: 1.5rem; border-radius: 4px; margin-top: 1.5rem; margin-bottom: 2rem;">
            <h4 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-bottom: 0.5rem; margin-top: 0;">🎒 Pro-Tip: Overlord Loadout</h4>
          ...
          <table class="guide-table" style="width: 100%; border-collapse: collapse; background: var(--dark-2);">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Phase 1 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Dimensional Rifts)</span></td>
              ...
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Phase 2 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Gravity Warp)</span></td>
              ...
              <tr>
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Final Phase <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Core Overload)</span></td>
      ...
      <section class="guide-section reveal" id="choice" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">4. The Diverging Path (Crucial Story Choice)</h2>
        <p class="reveal" style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">Immediately after defeating the Overlord, the entity known as the Primeval Voice will speak to Kliff. <strong>Your answer here determines the final chapter of the game.</strong></p>
        ...
        <div class="callout danger reveal" style="border-left: 4px solid #D4A843; background: rgba(212, 168, 67, 0.08); margin-top: 2rem; padding: 1.5rem;">
          <span class="callout-label" style="color: #D4A843; font-weight: bold; text-transform: uppercase;">⚠ Ending Requirements</span>
          <ul style="margin-top: 0.5rem; padding-left: 1.5rem; color: #ccc; line-height: 1.6;">
      ...
      <section class="guide-section reveal" id="hidden" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">5. Chapter 7 Hidden Treasures & Farming</h2>
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #9b59b6;">
            ...
            <h3 style="color: #9b59b6; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Farming: Void Crystals</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Before leaving the Abyss, farm the respawning "Void Sentinels" near the entrance. They have a 10% chance to drop Void Crystals, which are required to upgrade your Mythic weapons to +10 (Max Level).</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid var(--gold);">
            ...
            <h3 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Blade of the Echoes</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">During the "Grand Ocular" puzzle, if you align the light to hit the small gargoyle in the corner instead of the door, a secret pedestal will rise containing this Mythic Shortsword.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #3498db;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">🌀</span>
            <h3 style="color: #3498db; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Infinite Abyss Fragment</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Hidden inside the very first Gravity Well you encounter. You must turn the well OFF while standing inside it to reveal a hidden compartment beneath the floorboards.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #2ecc71;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">💍</span>
            <h3 style="color: #2ecc71; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Chronos Ring</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Found at the end of the "Path of Echoes". You must watch all 5 ghostly projections without skipping them. The ring grants a +20% duration to all your status buffs.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #f39c12;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">📜</span>
            <h3 style="color: #f39c12; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">The Creator's Diary</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Located on a floating island far to the West of the Citadel. Requires a perfect glide using the Abyss Wings and a full Stamina bar. Explains the origin of Kliff's resurrection.</p>
          </div>
        </div>
      </section>

      <section class="guide-section reveal" id="completion" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">6. Chapter 7 Completion</h2>
        ...
        <div class="reveal" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 1.5rem; margin-bottom: 3rem;">
            <ul class="guide-checklist">
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Secret Boss Defeated:</strong> Did you vanquish the Mirror Paradox?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Mythic Gear:</strong> Have you claimed the Blade of the Echoes?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Max Level Prep:</strong> Did you farm enough Void Crystals for Chapter 8?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Ending Path:</strong> Are you sure which dialogue option you are going to pick?</span>
                    </label>
                </li>
            </ul>
        </div>
        ...
        <div class="reveal" style="border-left: 4px solid #D4A843; padding: 1.5rem; background: var(--dark-2); border-radius: 0 4px 4px 0; display: flex; align-items: center; gap: 1.5rem;">
            ...
            <div>
                <h4 style="color: #D4A843; font-family: var(--font-display); font-size: 1.4rem; margin-bottom: 0.2rem; letter-spacing: 1px; margin-top: 0;">Achievement Unlocked</h4>
        ...
        <div class="chapter-nav">
            <a href="/crimson-desert/chapters/chapter-6.php" style="color: var(--text-dim); text-decoration: none; font-family: var(--font-ui); text-transform: uppercase; letter-spacing: 1px; font-size: 0.9rem;">← Previous: Chapter 6</a>
            <a href="/crimson-desert/chapters/chapter-8.php" class="btn btn-gold">Next: Chapter 8 →</a>
        </div>
