...
?>
  ...
  <header class="guide-hero" style="min-height: 40vh; padding-top: calc(var(--nav-h) + 2rem);">
    ...
    <div class="guide-hero-inner">
      ...
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem);">Chapter 3: The Frozen Peaks</h1>
      <p class="guide-hero-subtitle" style="font-family: var(--font-ui); font-size: 1.1rem; color: #ddd;">Survival, Ice Puzzles, and the Frost Dragon</p>
    </div>
  </header>
    ...
    <main class="guide-content">
      ...
      <section class="guide-section reveal">
        <div class="callout info" style="margin-bottom: 3rem;">
          <span class="callout-label">Chapter 3 Overview</span>
          <p><strong>Primary Location:</strong> The Kweiden Region (Snow Mountains)<br>
        ...
        <h2 class="guide-section-title">1. Preparing for the Ascent</h2>
        <p>Before heading into Kweiden from the northern Demeniss border, you must prepare. If you attempt to climb the mountain in standard armor, Kliff will freeze to death within 10 minutes of gameplay.</p>

        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">Acquire the Bear-Pelt Mantle & Climbing Pitons</h4>
              <p>Stop at the Border Outpost. Speak to the huntsman, Torald. He will ask for 3x Dire Wolf Pelts. Hunt them in the nearby forest to receive your first cold-weather gear. <strong>Important:</strong> Buy at least 15x <em>Iron Pitons</em> from his shop. You will need them to rest mid-climb.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">Craft "Spicy Crimson Stew"</h4>
              <p>Use the campfire near Torald to cook. Combine <strong>1x Boar Meat + 1x Fire Pepper + 1x Spring Water</strong>. This stew grants 30 minutes of complete immunity to the Freezing status, giving you a massive advantage during exploration.</p>
            </div>
          </li>
        </ul>
<div class="reveal" style="background: rgba(46, 204, 113, 0.1); border-left: 3px solid #2ecc71; padding: 1.2rem; margin-top: 1.5rem; border-radius: 0 4px 4px 0; display: flex; gap: 1rem; align-items: flex-start;">
        ...
        <h2 class="guide-section-title reveal">2. The Avalanche Pass & The Ice Caves</h2>
        <p class="reveal">The climb to the Dragon's peak is treacherous. You will need to rely heavily on the climbing mechanics and your stamina management.</p>

        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">Surviving the Avalanche Zone</h4>
              <p>As you ascend the "Widow's Trail", the screen will shake. When you hear the deep rumble, an avalanche is coming. Immediately sprint to the large black boulders and press crouch to take cover. If the snow hits you, you will be swept to the bottom of the mountain.</p>
            </div>
          </li>
        </ul>
        ...
        <div class="callout danger reveal" style="margin-top:2rem; background: rgba(140, 45, 45, 0.08); border-left: 4px solid #8C2D2D;">
          <span class="callout-label" style="color: #ff4d4d;">⚠ Enemy Warning: Ice Trolls</span>
          <p>Inside the caves, you will encounter Ice Trolls. They are <strong>completely immune to physical stagger</strong> unless you use Fire. Coat your sword in pitch or use Fire Arrows before engaging them, otherwise their heavy swings will break your guard instantly.</p>
        </div>
        ...
        <h2 class="guide-section-title reveal">3. The Kweiden Abyss Rift</h2>
        <p class="reveal">Just outside the Ice Caves exit, you will spot the purple glow of an Abyss Rift hidden behind a frozen waterfall. Use a heavy jumping attack to break the ice and enter <strong>The Shivering Void</strong>.</p>

        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">The Prism Puzzle</h4>
              <p>This rift requires you to guide a beam of pure light through three floating ice prisms. Hit the first prism with a light attack to turn it 90 degrees. Hit the second prism with a heavy attack to tilt it upwards. The beam will melt the central pillar, revealing the boss.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold);">Mini-Boss: The Glacial Knight</h4>
              <p>A slow but incredibly deadly armored knight. He wields a massive greatsword that creates ice spikes on the ground. <strong>Do not parry his overhead slams.</strong> Dodge to his right side (your left) and attack his unarmored back. Defeating him yields the <em>Kweiden Abyss Fragment</em> (increases max Stamina by 15%).</p>
            </div>
          </li>
        </ul>
        ...
        <h2 class="guide-section-title reveal">4. Chapter Boss: Ancient Frost Dragon</h2>
        <p class="reveal">At the summit, you will face one of the most spectacular encounters in the game. This is an aerial and environmental battle that tests your mastery of the Axiom Force.</p>
          ...
          <table class="guide-table" style="width: 100%; border-collapse: collapse; background: var(--dark-2);">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold;">Phase 1 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Grounded)</span></td>
              ...
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold;">Phase 2 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Aerial Assault)</span></td>
              ...
              <tr>
                <td style="padding: 1rem; font-weight: bold;">Final Phase <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Rodeo)</span></td>
        ...
        <div class="callout abyss reveal" style="margin-top:2rem; background: rgba(138, 43, 226, 0.08); border-left: 4px solid #A29BFE;">
          <span class="callout-label" style="color: #A29BFE;">Major Reward</span>
          <p>Defeating the Ancient Frost Dragon rewards you with the <strong>"Heart of Winter"</strong>. This upgrades your Axiom Force to Level 2, allowing you to grapple onto moving targets and enemies from much further away.</p>
        </div>

        <hr style="border-color: rgba(255,255,255,0.05); margin: 4rem 0;">

        <h2 class="guide-section-title reveal">5. Chapter 3 Hidden Collectibles & Loot</h2>
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid var(--gold);">
            ...
            <p style="font-size: 0.9rem; color: #ccc;">At the Avalanche Pass, climb the cliff to the right instead of hiding. At the top, you'll find a wounded White Wolf. Give it 3x Boar Meat to tame it. It moves 20% faster on snow.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #3498db;">
            ...
            <p style="font-size: 0.9rem; color: #ccc;">Hidden behind the frozen waterfall (near the Abyss Rift). Use a pickaxe to mine 5x Glacial Ores, required to craft Tier 3 weapons in Hernand.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #e74c3c;">
            ...
            <p style="font-size: 0.9rem; color: #ccc;">After the bridge puzzle in the Ice Caves, drop down onto a hidden ledge below the exit door. This sword deals innate ice damage and slows enemies.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #2ecc71;">
            ...
            <p style="font-size: 0.9rem; color: #ccc;">During the dragon fight, look around the edges of the summit arena. There is a frozen skeleton holding a pack containing 20x Expansion Tools.</p>
          </div>
        </div>

        <hr style="border-color: rgba(255,255,255,0.05); margin: 4rem 0;">
        <h2 class="guide-section-title reveal">6. Chapter 3 Completion</h2>
        
        <h3 class="reveal" style="font-family: var(--font-display); font-size: 1.8rem; color: var(--gold); margin-top: 2rem; margin-bottom: 1rem;">✅ Before Leaving Kweiden...</h3>
        <p class="reveal" style="color: #ccc; margin-bottom: 1.5rem;">The descent into the Akapen Desert in Chapter 4 will lock you out of this region for a while. Ensure you have:</p>
        ...
        <div class="reveal" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 1.5rem; margin-bottom: 3rem;">
            <ul class="guide-checklist">
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>Secret Mount:</strong> Did you tame the White Wolf at the Avalanche Pass?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>Legendary Weapon:</strong> Have you claimed the Frostbane Greatsword from the Ice Caves?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span><strong>Skill Upgrade:</strong> Is your Axiom Force successfully upgraded to Level 2?</span>
                    </label>
                </li>
            </ul>
        </div>
        ...
        <div class="reveal" style="margin-top: 4rem; text-align: right;">
          <a href="chapter-4.php" class="btn btn-gold">Next: Chapter 4 →</a>
        </div>
