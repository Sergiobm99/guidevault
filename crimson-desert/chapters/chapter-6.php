...
?>
  ...
  <header class="guide-hero" style="min-height: 45vh; padding-top: calc(var(--nav-h) + 2rem);">
    <div class="guide-hero-bg" style="background: linear-gradient(to bottom, rgba(8,8,8,0.4) 0%, rgba(8,8,8,1) 100%), url('/crimson-desert/img/chapter6.jpg') center/cover no-repeat;"></div>
    ...
    <div class="guide-hero-inner">
      ...
      <span class="label" style="color: var(--gold); letter-spacing: 0.2em; display: block; margin-bottom: 0.5rem;">WALKTHROUGH: PART 6</span>
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem); color: var(--gold); line-height: 1.1; margin-bottom: 1rem;">Chapter 6: The Scorched Earth</h1>
  ...
  <div class="guide-layout responsive-layout">
    ...
    <aside class="guide-toc desktop-toc" aria-label="Table of contents">
        ...
        <ul class="guide-toc-list" style="border-left: 1px solid rgba(255,255,255,0.1); padding-left: 1rem;">
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#siege" style="color: var(--text-dim); transition: color 0.2s;">1. The Siege of Harsand</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#puzzles" style="color: var(--text-dim); transition: color 0.2s;">2. The Molten Puzzles</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#boss-vulkan" style="color: var(--text-dim); transition: color 0.2s;">3. Boss: Molten Golem</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#hidden" style="color: var(--text-dim); transition: color 0.2s;">4. Hidden Treasures</a></li>
            <li class="guide-toc-item" style="margin-bottom: 0.5rem;"><a href="#completion" style="color: var(--text-dim); transition: color 0.2s;">5. Chapter Completion</a></li>
        </ul>
    </aside>

    <main class="guide-content">

      <section class="guide-section reveal" id="siege" style="margin-bottom: 4rem;">
        <div class="callout danger" style="margin-bottom: 3rem; background: rgba(140, 45, 45, 0.08); border-left: 4px solid #8C2D2D; padding: 1.5rem;">
          <span class="callout-label" style="color: #ff4d4d; font-weight: bold; text-transform: uppercase;">⚠ Environmental Hazard: Magma Ash</span>
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">The air in Mount Harsand is thick with toxic ash. Without a <strong>Fire-Resistant Mask</strong>, Kliff's stamina regeneration is halved. Additionally, standing on dark volcanic soil for too long will trigger "Burn" damage. Stay on the grey stone paths whenever possible.</p>
        </div>

        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">1. The Siege of Harsand Outpost</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">The war has reached a stalemate at the foot of the volcano. Your mission is to lead the Greymanes in a daring night assault to capture the Fire Outpost. This section heavily relies on the <strong>Tactical Command System</strong>.</p>
        ...
        <ul class="step-list">
          <li class="step reveal">
            ...
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Recruiting the Saboteurs</h4>
              <p style="color: #ccc;">Before the siege, head to the mercenary camp in the Ash Valley. You must recruit at least 3 <strong>Demolition Specialists</strong> (800 Gold each) to destroy the reinforced iron gates of the outpost.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">2</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Commanding the Charge</h4>
              <p style="color: #ccc;">As you advance, the enemy will fire flaming arrows. Use the D-Pad to issue the <strong>[Phalanx]</strong> command. Your shield units will form a wall around Kliff, reducing incoming projectile damage by 80%. When you breach the gates, switch to the <strong>[Berserk]</strong> command to quickly overwhelm the guards.</p>
            </div>
          </li>
          <li class="step reveal">
            <div class="step-num">3</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Alternate Route: The Weak Wall</h4>
              <p style="color: #ccc;">If you commanded a Saboteur to flank left during the initial charge, they will blow a hole in the western wall. This bypasses the heavily guarded courtyard entirely and leads straight to the inner sanctum.</p>
            </div>
          </li>
        </ul>
        ...
        <div class="callout danger reveal" style="margin-top:2rem; border-left: 4px solid var(--gold); background: rgba(212, 168, 67, 0.08); padding: 1.5rem;">
          <span class="callout-label" style="color: var(--gold); font-weight: bold; text-transform: uppercase;">⚠ Missable Companion Event: Save Yann</span>
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">Once you breach the main courtyard, you will hear Yann shouting for help. A burning siege tower is about to collapse on his squad. <strong>You only have 45 seconds.</strong> Ignore the enemies, sprint to the tower, and use a Heavy Attack to shatter the wooden supports locking him in. Saving him unlocks the "Brother in Arms" combo skill for the rest of the game.</p>
        </div>
      </section>

      <section class="guide-section reveal" id="puzzles" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">2. The Drawbridge & The Molten Puzzles</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">With the courtyard secured, you must push deeper into the volcano. But the path is blocked by elite forces and complex ancient machinery.</p>
        ...
        <ul class="step-list" style="margin-top:2rem;">
          <li class="step reveal">
            <div class="step-num">1</div>
            <div class="step-content">
              <h4 style="font-family: var(--font-display); font-size: 1.3rem; letter-spacing: 1px; color: var(--gold); margin-top: 0;">Mini-Boss: The Smoldering Centurion</h4>
              <p style="color: #ccc;">Before the puzzle room, you must cross the drawbridge guarded by this mini-boss. He wields a massive greatshield that spits fire. <strong>Do not attack from the front.</strong> Wait for him to perform his shield-charge, dodge-slide behind him, and strike his unarmored back. Drops: <em>Centurion's Crest</em>.</p>
            </div>
          </li>
        </ul>
        ...
        <div class="guide-accordion open reveal" id="acc-c6-1" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 2rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">There are three giant valves connected by pipes. The goal is to redirect the lava flow into the cooling pits to solidify a path.</p>
        ...
        <div class="guide-accordion open reveal" id="acc-c6-2" style="background: var(--dark-2); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; margin-top: 1rem;">
          ...
          <div class="guide-accordion-body">
            <div class="guide-accordion-inner" style="padding: 1.5rem;">
              <p style="color: #ccc; margin-bottom: 1rem;">After crossing the magma bridge, do NOT go through the main doors. Instead, jump down onto a small, isolated pillar of rock to the right. The purple Rift portal is hidden below eye level.</p>
              <ul style="list-style: square; padding-left: 1.5rem; color: #ccc;">
      ...
      <section class="guide-section reveal" id="boss-vulkan" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">3. Chapter Boss: Vulkan, the Molten Golem</h2>
        <p style="color: #ccc; font-size: 1.05rem; line-height: 1.7;">Vulkan is a colossal entity made of obsidian and living magma. He is slow but can end the fight in a single hit.</p>
          ...
          <table class="guide-table" style="width: 100%; border-collapse: collapse; background: var(--dark-2);">
            ...
            <tbody>
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Phase 1 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Obsidian Shell)</span></td>
              ...
              <tr style="border-bottom: 1px solid rgba(255,255,255,0.05);">
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Phase 2 <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Exposed Magma)</span></td>
              ...
              <tr>
                <td style="padding: 1rem; font-weight: bold; color: #ccc;">Final Phase <br><span style="font-size:0.75rem;color:#888; font-weight: normal;">(Supernova)</span></td>
        ...
        <div class="callout abyss reveal" style="margin-top:2rem; background: rgba(138, 43, 226, 0.08); border-left: 4px solid #A29BFE; padding: 1.5rem;">
          ...
          <p style="color: #ccc; margin-top: 0.5rem; margin-bottom: 0;">Defeating Vulkan grants the <strong>"Fragment of Ember"</strong>. This final elemental artifact allows Kliff to imbue any weapon with permanent Fire damage and grants 100% immunity to environmental burn effects.</p>
        </div>
      </section>

      <section class="guide-section reveal" id="hidden" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">4. Chapter 6 Hidden Treasures & Farming</h2>
        <p class="reveal" style="color: #ccc;">Mount Harsand is extremely hostile, which means many players rush through it and miss some of the most powerful mid-game items.</p>
        ...
        <div class="guide-cards" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1.5rem; margin-top: 1.5rem;">
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #e74c3c;">
            ...
            <h3 style="color: #e74c3c; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Farming: Meteorite Ore</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Along the western ridges of the volcano, you'll find glowing red rocks. Mine these for Meteorite Ore. You need 10 of these to craft the legendary "Greymane Warlord" armor set in Chapter 7.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid var(--gold);">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">🗡️</span>
            <h3 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Obsidian War-Axe</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Hidden in a secret room behind the first boss arena. Look for a wall with cracks glowing bright orange. Use a heavy Greatsword slam to break it. This axe ignores 30% of enemy armor.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #f39c12;">
            ...
            <h3 style="color: #f39c12; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">The Fire-Walker Boots</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Found at the very top of the volcano's chimney. Requires the "Sand-Dash" ability (from Chapter 4) to sprint across a narrow collapsing ledge before it falls into the magma.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #9b59b6;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">💍</span>
            <h3 style="color: #9b59b6; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Ring of the Salamander</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Inside the Magma Diverter puzzle room, instead of cooling the central pipe, look for a small grate below the South Valve. The ring is inside and boosts all fire damage dealt by 20%.</p>
          </div>
          <div class="guide-card-item reveal" style="background: var(--dark-2); padding: 1.5rem; border-radius: 4px; border-top: 3px solid #3498db;">
            <span class="guide-card-icon" style="font-size: 1.5rem; display: block; margin-bottom: 0.5rem;">📜</span>
            <h3 style="color: #3498db; font-family: var(--font-display); font-size: 1.3rem; margin-top: 0;">Secret Faction Note</h3>
            <p style="font-size: 0.9rem; color: #ccc; margin-bottom: 0;">Inside the Commander's tent in the outpost (second floor). Reveals a conspiracy between the Black Bears and the Abyss Wardens—an essential lore item needed for the "True Ending".</p>
          </div>
        </div>
        ...
        <div class="reveal" style="background: rgba(212, 168, 67, 0.05); border: 1px dashed var(--gold); padding: 1.5rem; border-radius: 4px; margin-top: 2.5rem;">
            <h4 style="color: var(--gold); font-family: var(--font-display); font-size: 1.3rem; margin-bottom: 0.5rem; margin-top: 0;">📈 Pro-Tip: The "Smoldering Gauntlet" EXP Farm</h4>
      ...
      <section class="guide-section reveal" id="completion" style="margin-bottom: 4rem;">
        <h2 class="guide-section-title" style="color: var(--gold); font-size: 2.2rem; margin-bottom: 1rem;">5. Chapter 6 Completion</h2>
        ...
        <div class="reveal" style="background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 4px; padding: 1.5rem; margin-bottom: 3rem;">
            <ul class="guide-checklist">
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Companion Saved:</strong> Did you rescue Yann before the siege tower collapsed?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Farming Complete:</strong> Did you mine at least 10 Meteorite Ores?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>True Ending Prep:</strong> Did you grab the Secret Faction Note in the Commander's tent?</span>
                    </label>
                </li>
                <li>
                    <label>
                        <input type="checkbox">
                        <span style="color: #ccc;"><strong>Artifact Secured:</strong> Did you obtain the Fragment of Ember from Vulkan?</span>
                    </label>
                </li>
            </ul>
        </div>
        ...
        <div class="chapter-nav">
            <a href="/crimson-desert/chapters/chapter-5.php" style="color: var(--text-dim); text-decoration: none; font-family: var(--font-ui); text-transform: uppercase; letter-spacing: 1px; font-size: 0.9rem;">← Previous: Chapter 5</a>
            <a href="/crimson-desert/chapters/chapter-7.php" class="btn btn-gold">Next: Chapter 7 →</a>
        </div>
