...
<style>
    ...
    /* 🛠️ MAGIA RESPONSIVA: Controla el layout en Móvil vs Escritorio */
    @media (max-width: 768px) {
        .desktop-toc { display: none !important; } /* Oculta el índice lateral en móvil */
        .responsive-layout { 
            display: block !important; 
            padding: 2rem 1rem !important; /* Márgenes seguros para el móvil */
        }
    }
    ...
    <div class="guide-layout responsive-layout">
        ...
        <main class="guide-content">
            ...
            <div style="text-align: center; margin-top: 5rem; padding-top: 3rem; border-top: 1px solid rgba(255,255,255,0.05);">
                ...
                <a href="/crimson-desert/chapters/prologue.php" class="btn btn-gold" style="font-size: 1.1rem; padding: 1rem 2rem;">START CHAPTER 1 WALKTHROUGH →</a>
            </div>
