...
?>
  ...
  <header class="guide-hero" style="min-height: 40vh; padding-top: calc(var(--nav-h) + 2rem);">
    ...
    <div class="guide-hero-inner">
      ...
      <h1 class="guide-hero-title" style="font-size: clamp(2.5rem, 5vw, 4.5rem);">Fashion & Mounts</h1>

      <p class="guide-hero-subtitle">Armor Sets, Transmogrification, and Bestial Companions</p>
  ...
  <div class="guide-layout" style="grid-template-columns: 1fr; max-width: 1050px;">
    ...
    <main class="guide-content">
      ...
      <section class="guide-section reveal">
        ...
        <div class="callout info">
          ...
          <span class="callout-label">The Tailor (Transmog System & Dyes)</span>

          <p>Once you reach <strong>Hernand City in Chapter 3</strong>, you will unlock the Master Tailor. This NPC allows you to change the appearance of your currently equipped armor to look like any piece of gear you have previously collected, without losing your stats. You can also apply rare Dyes found in hidden chests across Pywel.</p>

        </div>



        <h2 class="guide-section-title" style="margin-top: 4rem;">1. Iconic Armor Sets</h2>

        <p>A preview of the most sought-after armor sets in Pywel. Mix and match to create your perfect mercenary look.</p>
        ...
        <div class="gallery-grid">
          ...
          <div class="gallery-item">
            ...
            <img src="/crimson-desert/img/armor-greymane.png" alt="Greymane Commander Set" class="gallery-img" onerror="this.src='https://placehold.co/600x400/111111/D4AF37?text=Greymane+Commander'">

            <div class="gallery-content">

              <h3>Greymane Commander</h3>

              <p>Kliff's signature look. Heavy fur collar and reinforced steel plates. Perfect for cold environments.</p>

              <div class="dye-palette">

                <span class="dye-color" style="background: #2c3e50;" title="Midnight Blue"></span>

                <span class="dye-color" style="background: #7f8c8d;" title="Steel Grey"></span>

                <span class="dye-color" style="background: #8e44ad;" title="Royal Purple"></span>
          ...
          <div class="gallery-item">
            ...
            <div class="item-badge">Legendary</div>

           <img src="https://image.pollinations.ai/prompt/A%20high-quality,%20photorealistic%20character%20concept%20of%20a%20medieval%20fantasy%20royal%20guard%20wearing%20ornate%20heavy%20golden%20armor%20with%20a%20flowing%20red%20cape.%20Cinematic%20lighting,%20dark%20background,%208k%20resolution,%20RPG%20character%20design?width=600&height=400&nologo=true" alt="Demeniss Royal Guard" class="gallery-img">

            <div class="gallery-content">

              <h3>Demeniss Royal Guard</h3>

              <p>Ornate golden armor with a red cape. Highly durable but creates a lot of noise when sneaking.</p>

              <div class="dye-palette">

                <span class="dye-color" style="background: #f1c40f;" title="Polished Gold"></span>

                <span class="dye-color" style="background: #ecf0f1;" title="Silver"></span>

                <span class="dye-color" style="background: #e67e22;" title="Bronze"></span>
          ...
          <div class="gallery-item">
            ...
            <div class="item-badge badge-secret">Secret Set</div>
            ...
            <div class="gallery-content">
              ...
              <h3 style="color: #9b59b6;">Void Cultist Robes</h3>

              <p>Tattered, floating robes inscribed with glowing runes. Emits a faint purple aura in dark areas.</p>

              <div class="dye-palette">

                <span class="dye-color" style="background: #8e44ad;" title="Abyssal Purple"></span>

                <span class="dye-color" style="background: #2c3e50;" title="Deep Void"></span>
          ...
          <div class="gallery-item">
            ...
            <div class="gallery-content">
              ...
              <h3>Sun-Dancer Garb</h3>

              <p>Silken desert attire that breathes easily. Exposes Kliff's arms to show off mercenary tattoos.</p>

              <div class="dye-palette">

                <span class="dye-color" style="background: #d35400;" title="Desert Orange"></span>

                <span class="dye-color" style="background: #f39c12;" title="Sand Yellow"></span>

                <span class="dye-color" style="background: #16a085;" title="Oasis Green"></span>
        ...
        <div class="gallery-grid">
          ...
          <div class="gallery-item">
            ...
            <img src="/crimson-desert/img/mounts.png" alt="Akapen Sand-Strider" class="gallery-img" onerror="this.src='https://placehold.co/600x400/111111/D4AF37?text=Akapen+Sand-Strider'">

            <div class="gallery-content">

              <h3>Akapen Sand-Strider</h3>

              <p style="color: var(--gold); font-size: 0.8rem; margin-bottom: 0.5rem; letter-spacing: 1px;">TYPE: ARABIAN HORSE</p>

              <p><strong>Speed:</strong> ★★★★★<br><strong>Stamina:</strong> ★★★☆☆</p>

              <p style="margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid rgba(255,255,255,0.1);">Does not slow down in deep desert sand. Found near the Oasis Bazaar.</p>
          ...
          <div class="gallery-item">
            ...
            <div class="gallery-content">
              ...
              <h3>Kweiden Warbear</h3>

              <p style="color: var(--gold); font-size: 0.8rem; margin-bottom: 0.5rem; letter-spacing: 1px;">TYPE: EXOTIC BEAST</p>

              <p><strong>Speed:</strong> ★★☆☆☆<br><strong>Stamina:</strong> ★★★★★</p>

              <p style="margin-top: 0.5rem; padding-top: 0.5rem; border-top: 1px solid rgba(255,255,255,0.1);">Can trample enemies and break wooden barricades. Reward for Yann's Questline.</p>
        ...
        <div class="taming-steps">

            <div class="taming-step">

                <p><strong>Craft the Lariat:</strong> Visit any stable master to craft or buy a <em>Hemp Rope</em> and <em>Sugar Cubes</em>.</p>

            </div>

            <div class="taming-step">

                <p><strong>Approach Stealthily:</strong> Crouch and move slowly behind the wild horse. If the "Startle" meter fills up, it will bolt.</p>

            </div>

            <div class="taming-step">

                <p><strong>The Struggle:</strong> Throw the rope and complete the button-mashing mini-game. Use the sugar cubes when prompted to increase your success rate by 40%.</p>

            </div>

            <div class="taming-step">

                <p><strong>Registration:</strong> Ride the horse back to the nearest stable to name it and unlock its inventory slots.</p>
            ...
            <table class="guide-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span style="color: #ffd700;">★ Polished Gold</span></td>

                        <td><span class="pill pill-gold">Legendary</span></td>

                        <td>Reward for reaching 100% completion in the Demeniss region.</td>

                    </tr>

                    <tr>

                        <td><span style="color: #9b59b6;">★ Abyss Purple</span></td>

                        <td><span class="pill pill-violet">Epic</span></td>

                        <td>Dropped by Void Weavers in Master-Level Rifts.</td>

                    </tr>

                    <tr>

                        <td><span style="color: #e74c3c;">★ Crimson Blood</span></td>

                        <td><span class="pill pill-red">Rare</span></td>

                        <td>Found in a chest behind the waterfall at Akapen Peak.</td>

                    </tr>

                    <tr>

                        <td><span style="color: #bdc3c7;">★ Frost Silver</span></td>

                        <td><span class="pill pill-blue">Rare</span></td>

                        <td>Purchased from the Kweiden Ice-Trader after the "Frozen Heart" quest.</td>
        ...
        <div class="callout warning" style="margin-top: 3rem; border-left-color: #3498db; background: rgba(52, 152, 219, 0.05);">

          <span class="callout-label" style="color: #3498db;">Pro Tip: Photo Mode</span>

          <p>Press <strong>[L3 + R3 / P Key]</strong> to enter Photo Mode. You can adjust the time of day and weather to make your armor's metallic surfaces pop and take the perfect community screenshot!</p>
